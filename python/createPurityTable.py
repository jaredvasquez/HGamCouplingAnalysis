...
CatLabels = ["NONE","Rest, ==0j (Cen)","Rest, ==0j (Fwd)","Rest, ==1j, pT [0,60]","Rest, ==1j, pT [60,120]","Rest, ==1j, pT [120,200]","Rest, ==1j, pT [200,inf]","Rest, >=2j, pT [0,60]","Rest, >=2j, pT [60,120]","Rest, >=2j, pT [120,200]","Rest, >=2j, pT [200,inf]","VBF loose, LOW", "VBF loose, HIGH", "VBF tight, LOW","VBF tight, HIGH", "VH had loose","VH had tight","VBF BSM","VHMET, pT [0,150]","VHMET, pT [150,250]","VHMET, pT [250,inf]","VHlep, pT [0,150]","VHlep, pT [150,inf]","VHdilep, pT [0,150]","VHdilep, pT [150,inf]", "tHlep_0fwd","tHlep_1fwd","ttHlep", "ttHhad_6j2b","ttHhad_6j1b","ttHhad_5j2b","ttHhad_5j1b","ttHhad_4j2b","ttHhad_4j1b"]
